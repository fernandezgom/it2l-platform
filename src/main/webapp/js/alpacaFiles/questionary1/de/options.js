var options = {
    "fields": {
    	"question1": {
        	"label": "1.- Learning with a computer is fun.",
        	"type": "radio",
        	"helper": "1 - Don't agree at all. 5 - Totally agree",
        	"optionLabels": ["1", "2", "3", "4", "5"],
        	"vertical": false
    	},
    	"question2": {
        	"label": "2.- Learning with a computer is fun.",
        	"type": "radio",
        	"helper": "",
        	"optionLabels": ["1", "2", "3", "4", "5"],
        	"vertical": false
    	...
    	"question4": {
        	"label": "4.- Learning with a computer is fun.",
        	"type": "radio",
        	"helper": "",
        	"optionLabels": ["1", "2", "3", "4", "5"],
        	"vertical": false
    	...
    	"question5": {
        	"label": "5.- Learning with a computer is fun.",
        	"type": "radio",
        	"helper": "",
        	"optionLabels": ["1", "2", "3", "4", "5"],
        	"vertical": false
    	...
    	"question6" : {
            "label": "6.- Which number line correctly shows 3/4?",
        	"type": "radio",
        	"helper": "",
        ...
        "question7": {
        	"label": "7.- Select the representations that show 1/3.",
        	"type": "checkbox",
        	"helper": "There are more than one.",
    	...
    	"question10": {
        	"label": "10.- 3/4 = 6/[  ] What goes in the box?",
        	"type": "select",
        	"helper": "",
